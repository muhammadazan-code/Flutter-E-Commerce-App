  ...
  String get message {
    switch (code) {
      case 'too-many-requests':
        return 'Temporarily unavailable. We have blocked all requests from this device due to unusual acitivity.';
      ...
      case 'user-disabled':
        return 'This userr account has been disable. Please contact support for assistance.';
      case 'user-not-found':
      ...
      default:
        return 'An unexpected authentication error occured. Please try again.';
    }
  }
}
